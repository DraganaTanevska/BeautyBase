...
namespace BeautyBaseFinal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddUserToRole()
        {
            ...
            model.roles = new List<string>() { "Admin", "Client" };
            return View(model);
        }
        [HttpPost]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, MobilePhone = model.MobilePhone };
